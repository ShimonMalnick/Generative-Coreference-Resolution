...
def parse_args():
    ...
    parser.add_argument("--sent_step", type=int)
    ...
    parser.add_argument("--baseline", action="store_true", help="training baseline models")
    parser.add_argument("--causal_tokenization", action="store_true", help="useing causal tokenization scheme")
    parser.add_argument("--eval_generate", action="store_true", help="whether to generate during evaluation while training")
    parser.add_argument("--store_pred", action="store_true", help="whether to store conll prediction file")
    parser.add_argument("--verbose", action="store_true", help="verbose printing mode")
    parser.add_argument('--eliav', dest='eliav', action='store_true', help="use this flag when eliav is running, for log directories")
    parser.add_argument("--num_beams", type=int, required=False, default=3)
    parser.set_defaults(eliav=False)
